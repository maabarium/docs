...
If you care about optimised local builds, runtime performance, and advanced platform-specific behaviour, continue into [Build Profiles and Runtime Behaviour](/reference/build-profiles-and-runtime-behavior).
