...
If you care about optimized local builds, runtime performance, and advanced platform-specific behavior, continue into [Build Profiles and Runtime Behavior](/reference/build-profiles-and-runtime-behavior).
