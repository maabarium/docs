...
- `latest.json` points at the signed updater bundle for the right platform and architecture
- the installed app uses the same updater origin when you check for updates later
...
- generated install script behavior
